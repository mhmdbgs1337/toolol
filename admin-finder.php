<?php 
  /*
    Admin Finder PHP
    Coded by HatsuSec
    www.github.com/mhmdbgs1337
    www.facebook.com/mhmdbgs1337
  */
  error_reporting(0);
  if (!isset($_POST['url'])) {
?>
      ...
      <?php
        foreach($adminpages as $page) {
          ...
          if (eregi('200', $retornado[0])) {
            echo "<p class='ok'><font color='green'><b><a href='".$url.$page."'>Klick Me Senpai</a></b></font></p>";
          } else {
            echo "<p class='no'></p>";
          }
        }
